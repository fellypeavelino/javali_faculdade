...
public class Usuario {
    ...
    public boolean logar(Usuario u) throws SQLException{
        ...
        p.con = p.conectar();
        p.stm = p.con.prepareStatement("select count(nome) from ususario where nome='"+u.getNome()+"' and senha='"+u.getSenha()+"'");
    ...
    public void inserir(Usuario u) throws SQLException{
        Principal p = new Principal();
        p.con = p.conectar();
        p.stm = p.con.prepareStatement("insert into ususario (nome, senha) values ('"+u.getNome()+"', '"+u.getSenha()+"');");
        p.stm.execute();
        p.stm.close();
        p.desconectar();
    }
    ...
    public ArrayList<Usuario> lista() throws SQLException{
        ...
        Principal p = new Principal();
        p.con = p.conectar();
        p.stm = p.con.prepareStatement("select * from ususario");
